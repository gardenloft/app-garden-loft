// // this code give 'console warning expo token'
...
//           Linking.openURL(`app-garden-loft://VideoSDK2?meetingId=${meetingId}?caller=${caller}&sutoJoin=true`);
...
//       })).data;
//       console.log("this is the token given back,", token)
//     } else {
...
// this code gives 'console error' for expo token
