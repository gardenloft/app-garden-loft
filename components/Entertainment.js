...
//             {
//               backgroundColor:
//                 item.id === categories[activeIndex]?.id ? "#f3b718" : "t#f3b718",
//               transform:
...
//             {
//               backgroundColor:
//                 item.id === categories[activeIndex]?.id ? "transparent" : "transparent",
//               transform:
//                 item.id === categories[activeIndex]?.id
//                   ? [{ scale: 1 }]
//                   : [{ scale: 1 }],
...
//           <Image source={{ uri: item.imageUrl, cache: "force-cache" }} style={styles.imageUrl} />
//           <Text style={styles.cardText}>{item.name}</Text>
//         </Pressable>
//       );
//     }
...
//                   }}>
//                     <Image source={{ uri: subcategory.imageUrl, cache: "force-cache" }} style={styles.imageUrl} />
...
//                   }}>
//                     <Image source={{ uri: season.imageUrl, cache: "force-cache" }} style={styles.imageUrl} />
...
//                   style={[
//                     styles.seasonButton,
//                     episode.isWatched && styles.watchedOverlay, // Apply watched style
//                   ]}
//                   onPress={() => {
//                     openEpisodeModal(episode);
//                     setIsSeasonModalVisible(false);
//                   }}>
//                     <Image source={{ uri: episode.imageUrl, cache: "force-cache" }} style={styles.imageUrl} />
