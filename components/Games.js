...
//           </Text>
//           <Pressable style={styles.proceedButton} onPress={proceedToGame}>
//             <Text style={styles.proceedText}>Proceed to Game</Text>
//           </Pressable>
//         </View>
//       </Modal>
...
//             <ActivityIndicator size="large" color="orange" />
//           ) : (
//             <WebView source={{ uri: gameUrls[selectedGame?.name] }} style={{ width: viewportWidth * 0.95, height: viewportHeight * 0.7 }} />
//           )}
//           <Pressable style={styles.closeButton} onPress={closeGameModal}>
//             <FontAwesome name="close" size={24} color="black" />
//           </Pressable>
...
//   filterButton: { padding: 10, margin: 5, borderRadius: 5, backgroundColor: "grey" },
//   activeFilterButton: { backgroundColor: "orange" },
//   filterText: { color: "white", fontWeight: "bold" },
//   cardContainer: { width: viewportWidth * 0.3, backgroundColor: "#f09030", borderRadius: 20, alignItems: "center", marginHorizontal: 10 },
//   cardImage: { width: "100%", height: "100%" },
//   cardText: { fontSize: 30, color: "#393939", fontWeight: "700", textAlign: "center", marginTop: 10 },
//   arrowLeft: { position: "absolute", zIndex: 10, left: -22, top: "40%", transform: [{ translateY: -50 }] },
//   arrowRight: { position: "absolute", zIndex: 10, right: -22, top: "40%", transform: [{ translateY: -50 }] },
//   modalView: { margin: 10, height: viewportHeight * 0.88, width: viewportWidth * 0.95, marginTop: 50, backgroundColor: "white", borderRadius: 20, padding: 20, alignItems: "center", justifyContent: "center" },
//   modalText: { fontSize: 20, textAlign: "center", marginBottom: 20 },
//   proceedButton: { backgroundColor: "#f09030", padding: 15, borderRadius: 10 },
//   proceedText: { fontSize: 20, color: "white", fontWeight: "bold" },
//   closeButton: { position: "absolute", top: 10, right: 30, backgroundColor: "lightblue", padding: 13, borderRadius: 5 },
// });
