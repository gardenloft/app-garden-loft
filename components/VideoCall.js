...
//   const { calleeId } = useLocalSearchParams();
...
//   const fetchUserNames = async (userId) => {
//     //uncommented function is used for individualed 
//     // const querySnapshot = await getDocs(collection(FIRESTORE_DB, `users/${userId}/contacts`));
...
//       // meetingId: doc.data().meetingId
//       expoPushToken: doc.data().pushToken,
//       uid: doc.id
//     }));
//     setUserNames(fetchedUserNames);
//   };
...
//     });
//     console.log('Starting video call with Callee User ID:', calleeUid);
...
//        }]}
//       onPress={() => startVideoCall(item.uid)} // Pass the meetingId here
//     >
