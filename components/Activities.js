//the code below has all the filters but the cards are not clicking and opening into the join now modal
...
//     justifyContent: "center",
//     marginBottom: 20, 
//     marginTop: viewportWidth > viewportHeight ? 190 : 300,    
//   },
//   filterButton: {
...
//this below code has filters but the carousels above doesnt work when it loads
// import React, { useState, useEffect, useRef } from "react";
// import {
//   View,
//   Text,
...
//   const scheduleNotification = async (event) => {
//     const notificationTime = new Date(event.startDate.getTime() - 10 * 60 * 1000);
//     const currentTime = new Date();
...
//     } else {
//       console.warn(
//         "Failed to schedule notification. The notification time must be in the future."
//       );
//     }
//   };
